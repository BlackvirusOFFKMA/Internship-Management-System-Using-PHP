...
class User extends Model
{
    ...
    public function validate($DATA, $id = '')
    {
        ...
        if (empty($DATA['firstname']) || !preg_match('/^[A-Za-zÀÁÂÃÈÉÊỄÌÍÒÓÔÕÙÚÝàáâãèéêễìịíòóôõùúýĂăĐđĨỊĩŨũƠơƯưẠ-ỹ\s]+$/i', $DATA['firstname'])) {
            $this->errors['firstname'] = "Only letters allowed in first name";
        }

        //check for last name
        if (empty($DATA['lastname']) || !preg_match('/^[A-Za-zÀÁÂÃÈÉÊỄÌÍÒÓÔÕÙÚÝàáâãèéêễìịíòóôõùúýĂăĐđĨỊĩŨũƠơƯưẠ-ỹ\s]+$/i', $DATA['lastname'])) {
